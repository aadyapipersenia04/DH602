...
class TrainingConfig:
	output_dir = "/home/varad/test/"
	# seed = 0
	eval_batch_size = 32
	num_batches = 64
	gpu_number = 3 # GPU to choose

      
def evaluate(config):
	pipeline = DDPMPipeline.from_pretrained('/home/varad/ddpm-granulocytes', use_safetensors=True).to(f"cuda:{config.gpu_number}")
