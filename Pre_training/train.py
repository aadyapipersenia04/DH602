...
class TrainingConfig:
    ...
    output_dir = "/home/varad/ddpm-granulocytes"  # the model name locally and on the HF Hub
...
#granulocytes = []
#for p in range(0, len(train_dataset)):
#  if train_dataset[p][1][0] == 6:
#     granulocytes.append(train_dataset[p][0])
# print(granulocytes)

#for t in granulocytes:
#  plt.figure(figsize=(2.5, 2.5))
#  plt.imshow(np.array(t).reshape(config.image_size, config.image_size, 3))
#  plt.show()
#  break
